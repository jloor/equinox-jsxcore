...
reference application, with DDD, CQRS, Event Sourcing, the full architecture. Its views are
...
claims about it. That single decision, verify first and then execute, is the only reason
